class Convert:    
    ...
    def processing(self):
        file1 = open('C:\Users\Anjali Ashok\workspace\Stenography\src\\dict.json.txt', 'r')
        ...
        clean_d = { k.strip():v.strip() for k, v in new_dict.iteritems()}
        
        a = 'I am Anjali'
        b = 'anjali is'
        c = self.LongestCommonSubstring( a , b );
        print c
        for m in list1:
    ...
    def test(self):
        ...
        c = self.LongestCommonSubstring('anfmfjhbali', 'anjali is');
        print c
